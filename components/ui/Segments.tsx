...
export default function Segments<T extends string>({
  ...
  return (
    <div
      ...
      className="flex gap-1 rounded-[11px] border border-border bg-wash-strong p-1"
    >
      {options.map((o) => {
        ...
        return (
          <button
            ...
            className={`flex-1 whitespace-nowrap rounded-lg px-3.5 py-2.5 text-[14.5px] font-semibold transition-colors duration-150 ease-out focus-visible:outline-none focus-visible:shadow-[0_0_0_3px_rgba(46,125,158,0.15)] ${
              actif
