...
- [x] **12.1 — Le podium d'un contrôle, publié dans le fil** · branche `classement-controle`
  ...
  **Vérifié** : sur le test du 17/09 (15 copies, 14 hors compte de test), podium ABDELALI ARMAS 16,25 / KHADIJA FAHMI 16 / SARA NAIT AISSI 15,5, moyenne 12,5/20, ex æquo à 12/20 classés 7ᵉ et 7ᵉ puis 9ᵉ — et le compte de test absent. Sur le CC 1, dont aucune copie n'est publiée, aucun bloc de classement n'apparaît. Politiques vérifiées dans une transaction annulée : un stagiaire du groupe lit le classement, un compte étranger ne lit rien.
