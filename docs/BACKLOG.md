...
- [ ] **1.3** — Prompt : *"Crée la migration `014_suggestions_pedagogiques.sql` : table `suggestions_pedagogiques` (id, element_competence_id, apprentissage_base text, elements_contenu text, activites_apprentissage text, duree_suggeree_pourcent numeric)."*
